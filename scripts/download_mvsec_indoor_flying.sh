#!/bin/bash
# Download MVSEC dataset (HDF5 files) from Google Drive
# Source: https://drive.google.com/drive/folders/1CEuvvahWQntNIqXWZhXu_WknsTLm4Sum
# Expected destination: data/MVSEC/data_hdf5/

FOLDER_ID="1CEuvvahWQntNIqXWZhXu_WknsTLm4Sum"
DEST_DIR="$(cd "$(dirname "$0")/.." && pwd)/data/MVSEC/data_hdf5"
...
echo "[INFO] Downloading MVSEC HDF5 files to: $DEST_DIR"
mkdir -p "$DEST_DIR"
