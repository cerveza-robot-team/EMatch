...
from datasets.EVB_CIRS.CustomSequence_ematch_mvsec import CustomSequence_ematch_mvsec
...
def main(args):
    ...
    for name in sequence_names:
        datasets.append((name, CustomSequence_ematch_mvsec(config_dataset, name)))
